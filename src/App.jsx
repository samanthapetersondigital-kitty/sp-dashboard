// ============================================================
// Scott Peters Dashboard — App.jsx
...
const DATA = {
  ...
  finances: {
    ...
    digitalTarget: 0.10,
    byMonth: [
      { month: "2025-11", total: 2336.5, digital: 334.5 },
      { month: "2025-12", total: 20072.5, digital: 215.5 },
      { month: "2026-01", total: 9533.5, digital: 956.5 },
      { month: "2026-02", total: 7713.5, digital: 1584.5 },
      { month: "2026-03", total: 32518.5, digital: 3165.5 },
      { month: "2026-04", total: 2185.0, digital: 45.0 }
    ],
  },

  texting: {
    campaigns: [
      // Add texting campaigns here
    ],
    costPerMsg: 0.07,
  },
  ...
  return (
    <div style={{ fontFamily:"Arial,sans-serif", maxWidth:1100, margin:"0 auto", padding:20 }}>
      <h1 style={{ background:"#1F4E79", color:"#fff", padding:"12px 20px", borderRadius:6, marginBottom:16 }}>
        Scott Peters — Digital Dashboard ({DATA.period})
      </h1>
