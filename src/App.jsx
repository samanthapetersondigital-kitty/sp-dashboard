...
const PASSWORD = "pet2026";

function PasswordGate({ children }) {
  const [authed, setAuthed] = useState(() => sessionStorage.getItem("sp_auth") === "1");
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "100vh", background: "#060f1a" }}>
      <div style={{ background: "#091929", border: "1px solid #1e3a5f", borderRadius: 12, padding: "40px 48px", minWidth: 320, textAlign: "center" }}>
        <div style={{ fontSize: 22, fontWeight: 700, color: "#fff", marginBottom: 8 }}>Scott Peters Dashboard</div>
...
const EMAIL_TOP_LINES = [
  {
    "subject": "SP_EM_EN_180DO_260106_1_1",
    "sendDate": "1/6/26",
    "period": "weekly",
    "recipients": 7307,
    "opens": 2138,
  ...
  {
    "subject": "SP_EM_FR_180DO_260116_1_1",
    "sendDate": "1/16/26",
    "period": "weekly",
    "recipients": 7261,
    "opens": 2157,
  ...
  {
    "subject": "SP_EM_FR_180DO_260116_2_2",
    "sendDate": "1/16/26",
    "period": "weekly",
    "recipients": 7248,
    "opens": 2229,
  ...
  {
    "subject": "SP_EM_FR_180DO_260121_1_1",
    "sendDate": "1/21/26",
    "period": "weekly",
    "recipients": 7230,
    "opens": 2203,
  ...
  {
    "subject": "SP_EM_EN_90DO_260123_1_1",
    "sendDate": "1/23/26",
    "period": "weekly",
    "recipients": 6510,
    "opens": 2227,
  ...
  {
    "subject": "SP_EM_EN_90DO_260128_1_1",
    "sendDate": "1/28/26",
    "period": "weekly",
    "recipients": 6640,
    "opens": 3458,
...
// ─── GROWTH CALC ──────────────────────────────────────────────────────────────
const GROWTH_CALC = [
  { metric: "Avg Open Rate", value: "38.8%", benchmark: ">14% = Strong", status: "above" },
  { metric: "Avg Click Rate", value: "6.0%", benchmark: ">3.0%", status: "above" },
  { metric: "Digital % of ActBlue", value: "8.5%", benchmark: "10–15%", status: "below" },
];

const DEFAULT_HIGHLIGHTS = [
  "Dashboard initialized with data through April 14, 2026",
  "Digital raise: $6,302 (8.5% of total ActBlue)",
  "Average email open rate: 38.8%",
  "Total ActBlue raised: $74,360",
];
      ...
      <div style={{ minHeight: "100vh", background: "#060f1a", color: "#e2e8f0", fontFamily: "'Inter', sans-serif" }}>
        ...
        <header style={{ position: "sticky", top: 0, zIndex: 100, background: "rgba(6,15,26,0.96)", backdropFilter: "blur(12px)", borderBottom: "1px solid #1e3a5f", padding: "0 32px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 64 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 14 }}>
            <div style={{ width: 36, height: 36, borderRadius: 8, background: "linear-gradient(135deg,#1d4ed8,#3b82f6)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 15, fontWeight: 800, fontFamily: "'Sora', sans-serif", color: "#fff" }}>{"SP"}</div>
            <div>
